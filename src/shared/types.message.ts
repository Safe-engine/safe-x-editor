import {
  ...
  SYNC_RES_REQUEST, RENAME_RESOURCE_REQUEST, IMPORT_RESOURCES_REQUEST, GEN_COMPONENT_REQUEST, GEN_PROP_TYPES_REQUEST, GET_FOLDER_FILES,
...
export type IpcRequest =
  ...
  | { key: typeof CREATE_SPRITE_IMAGE_ASSET_FILE_REQUEST, rootFolder: string, targetPath: string, targetKey: string, sourcePath: string }
  | { key: typeof CREATE_SPRITE_IMAGE_ASSET_CLIPBOARD_REQUEST, rootFolder: string, targetPath: string, targetKey: string }
...
export type IpcResponse =
  ...
  | { key: typeof CREATE_SPRITE_IMAGE_ASSET_FILE_REQUEST }
  | { key: typeof CREATE_SPRITE_IMAGE_ASSET_CLIPBOARD_REQUEST }
